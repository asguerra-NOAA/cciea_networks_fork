...
) # generated in script 00_process
...
bodega_2022 <- intersect(
  intersect(
    list.files(here::here(pngdir_ports), pattern = "Bodega"),
    list.files(here::here(pngdir_ports), pattern = "circular")
  ),
  list.files(here::here(pngdir_ports), pattern = "2022")
)
bodega_2025 <- intersect(
  intersect(
    list.files(here::here(pngdir_ports), pattern = "Bodega"),
    list.files(here::here(pngdir_ports), pattern = "circular")
  ),
  list.files(here::here(pngdir_ports), pattern = "2025")
)

img_bb2022 <- magick::image_read(
  here::here(pngdir_ports, bodega_2022)
)
...
img_bb2025 <- magick::image_read(
  here::here(pngdir_ports, bodega_2025)
)
...
gg_bb2022 <- ggplot() +
  annotation_raster(
    img_bb2022,
    xmin = 0,
    xmax = info_bb2022$width,
    ymin = 0,
    ymax = info_bb2022$height
  ) +
  coord_fixed() +
...
gg_bb2025 <- ggplot() +
  annotation_raster(
    img_bb2025,
    xmin = 0,
    xmax = info_bb2025$width,
    ymin = 0,
    ymax = info_bb2025$height
  ) +
  coord_fixed() +
...
ggsave(
  here::here(
    pngdir_ports,
    paste0('bodega bay 2022 v 2025_', Sys.Date(), '.png')
  ),
  bb2022_2025,
  width = 6,
  height = 10,
...
monterey_2022 <- intersect(
  intersect(
    list.files(here::here(pngdir_ports), pattern = "Monterey"),
    list.files(here::here(pngdir_ports), pattern = "circular")
  ),
  list.files(here::here(pngdir_ports), pattern = "2022")
)
monterey_2025 <- intersect(
  intersect(
    list.files(here::here(pngdir_ports), pattern = "Monterey"),
    list.files(here::here(pngdir_ports), pattern = "circular")
  ),
...
img_mt2022 <- magick::image_read(
  here::here(pngdir_ports, monterey_2022)
)
...
img_mt2025 <- magick::image_read(
  here::here(pngdir_ports, monterey_2025)
)
...
gg_mt2022 <- ggplot() +
  annotation_raster(
    img_mt2022,
    xmin = 0,
    xmax = info_mt2022$width,
    ymin = 0,
    ymax = info_mt2022$height
  ) +
  coord_fixed() +
...
gg_mt2025 <- ggplot() +
  annotation_raster(
    img_mt2025,
    xmin = 0,
    xmax = info_mt2025$width,
    ymin = 0,
    ymax = info_mt2025$height
  ) +
  coord_fixed() +
...
ggsave(
  here::here(pngdir_ports, paste0('monterey 2022 v 2025_', Sys.Date(), '.png')),
  mt2022_2025,
  width = 6,
  height = 10,
  dpi = 600
